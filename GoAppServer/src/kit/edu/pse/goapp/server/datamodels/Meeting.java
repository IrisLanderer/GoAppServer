...
public abstract class Meeting {
     ...
     */
    public Meeting(int meetingId, String name, GPS place, long timestamp,
            int duration, Participant creator) {
    ...
    /**
     * Meeting participant status of an user
     * 
     * @param user
     *            user
     * @throws IOException
     ...
     */
    public void isParticipant(User user)
        ...
        if (!isParticipant) {
            throw new CustomServerException(
                    "The user has to be participant of this meeting to access it!",
                    HttpServletResponse.SC_UNAUTHORIZED);
        }
    }

    /**
     * Creator status of an user
     * 
     * @param user
     *            user
     * @throws IOException
    ...
    public void isCreator(User user) throws IOException, CustomServerException {
        ...
        if (!(creator.getUser().getId() == user.getId())) {
            throw new CustomServerException(
                    "The user has to be creator of this meeting to access it!",
                    HttpServletResponse.SC_UNAUTHORIZED);
        }
    }
