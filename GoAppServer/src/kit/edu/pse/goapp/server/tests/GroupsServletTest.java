...
import kit.edu.pse.goapp.server.servlets.GroupsServlet;

/**
 * @author Iris
 *
 */
public class GroupsServletTest extends GroupsServlet {
	...
	public void testDoGet() throws ServletException, IOException, CustomServerException {
		...
		GroupsServletTest servlet = new GroupsServletTest();
