...
public class MeetingDaoTest extends MeetingDaoImpl {
	...
	// assertEquals(expectedEvent.getPlace().getX(), event.getPlace().getX(),
	// 3);
	// assertEquals(expectedEvent.getPlace().getY(), event.getPlace().getY(),
	// 3);
	// assertEquals(expectedEvent.getPlace().getZ(), event.getPlace().getZ(),
	// 3);
	// assertEquals(expectedEvent.getTimespamp(), event.getTimespamp());
	// assertEquals(expectedEvent.getDuration(), event.getDuration());
	// assertEquals(expectedEvent.getCreator().getParticipantId(),
	// event.getCreator().getParticipantId());
	//
	// }
