    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            if (dao != null) {
                ...
                response.getWriter().write(new ObjectConverter<User>()
                        .serialize(user, User.class));
            }
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            response.getWriter().write(
                    new ObjectConverter<User>().serialize(user, User.class));
            // }
        } catch (CustomServerException e) {
            response.setStatus(e.getStatusCode());
            response.getWriter().write(e.toString());
    ...
    protected void doPut(HttpServletRequest request,
        ...
        try {
            ...
            if (userId != dao.getUserId()) {
                throw new CustomServerException(
                        "The UserID from the JSON string isn't the same as the actual user!",
                        HttpServletResponse.SC_BAD_REQUEST);
            }
            if (dao != null) {
                dao.updateUser();
